...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/tag/'.$data->tag_id)}}" method="post">
            {{csrf_field()}}
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="tag_name" value="{{$data->tag_name}}">
                        <p>标题可以写30个字</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="tag_color" value="{{$data->tag_color}}">
                        <p>标题可以写7个字</p>
                    </td>
                </tr>
                <tr>
