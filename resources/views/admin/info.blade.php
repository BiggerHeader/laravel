@extends('layout.layout1')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a>  &raquo; 信息页面
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>北京时间</label><span><?php echo date('Y-m-d     H:m:s',time()) ?></span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://bbs.datou.com</a></span>
                </li>
                <li>
